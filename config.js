...
const aURL = [
  ...
  ["ff9100", "Refresh", "#", "1"],
  ["0dd1a7", "Help", "#", "1"],
  ["2196F3", "WAVELOG", "https://log.nq0m.com/", "1"],
  [
    "2196F3",
    "CONTEST",
  ...
  [
    "2196F3",
    "WEATHER",
    "https://openweathermap.org/weathermap?basemap=map&cities=true&layer=temperature&lat=37.9139&lon=-95.4176&zoom=10",
    "1",
    "R",
  ],
  [
    "2196F3",
    "WINDS",
    "https://earth.nullschool.net/#current/wind/surface/level/orthographic=-95.42,37.91,3000",
    "1",
    "R",
  ],
];
